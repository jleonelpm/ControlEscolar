 ...
 * @author Last Develop
 */
public class dlgBuscarAlumno extends javax.swing.JDialog {
    ...
    public dlgBuscarAlumno(java.awt.Frame parent, boolean modal) throws SQLException, ClassNotFoundException {
        super(parent, modal);
        initComponents();
...
private void tablaAlumnosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaAlumnosMouseClicked
    ...
    if (filas > -1) {
        ...
        if (objalumn.getNombre() != null) {
            try {
                ...
                Logger.getLogger(dlgBuscarAlumno.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgBuscarAlumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    dlgBuscarAlumno dialog = new dlgBuscarAlumno(new javax.swing.JFrame(), true);
