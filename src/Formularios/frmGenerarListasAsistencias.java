...
import Reportes.JRDListaAsistencia;
 ...
 * @author Last Develop
 */
public class frmGenerarListasAsistencias extends javax.swing.JDialog {
    ...
    public frmGenerarListasAsistencias(java.awt.Frame parent, boolean modal) throws SQLException, ClassNotFoundException {
        super(parent, modal);
        initComponents();
      ...
      CicloEscolar cicloactivo=ctrlcicloescolar.getCicloActivo();
      this.cmbCicloEscolar.setSelectedItem(cicloactivo);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(cmbCicloEscolar, 0, 282, Short.MAX_VALUE))
        ...
        try {
            OfertaAcademica e=(OfertaAcademica) this.cmbAsignaturas.getSelectedItem();
             ...
             EncabezadoListasAsistencia encabezado=new EncabezadoListasAsistencia();
              ...
              encabezado.setPeriodo_escolar(ciclo.getPeriodo());
             ...
             ArrayList<Alumnos> listaAsistencia=ctrlalumnos.getListaAsistencia(ciclo.getIdCiclo(), e.getIdOfertaAcademica());
             JRDListaAsistencia reporte=new JRDListaAsistencia();
             if(listaAsistencia!=null)
             {
              ...
              String archivo=ruta+"\\src\\Reportes\\rptListasAsistencia.jrxml";
...
private void cmbCicloEscolarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbCicloEscolarActionPerformed
        try {
            // TODO add your handling code here:
             ...
             CicloEscolar ciclo=(CicloEscolar) this.cmbCicloEscolar.getSelectedItem();
             ArrayList<Grupos> listagrupos= ctrlgrupos.getGruposListasAsistencia(ciclo.getIdCiclo());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmGenerarListasAsistencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    frmGenerarListasAsistencias dialog = new frmGenerarListasAsistencias(new javax.swing.JFrame(), true);
