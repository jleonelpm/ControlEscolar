 ...
 * @author Last Develop
 */
public class dlgBuscarAlumnoBajas extends javax.swing.JDialog {
    ...
    public dlgBuscarAlumnoBajas(java.awt.Frame parent, boolean modal) throws SQLException, ClassNotFoundException {
        super(parent, modal);
        initComponents();
...
private void tablaAlumnosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaAlumnosMouseClicked
    ...
    if (filas > -1) {
        ...
        if (objalumn.getNombre() != null) {
            try {
                ...
                Logger.getLogger(dlgBuscarAlumnoBajas.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgBuscarAlumnoBajas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    dlgBuscarAlumnoBajas dialog = new dlgBuscarAlumnoBajas(new javax.swing.JFrame(), true);
